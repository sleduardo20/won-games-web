import { CartContextData, defaultValuesCartContext } from 'hooks/useCart';
...
jest.mock('@stripe/react-stripe-js', () => ({
  ...
  useElements: jest.fn().mockResolvedValue({
    getElement: jest.fn(),
  }),
}));
...
describe('<PaymentForm />', () => {
  ...
  it('should be able render component correctly', () => {
  ...
  it('should be able call create payment when it renders and render free it gets freeGames', async () => {
